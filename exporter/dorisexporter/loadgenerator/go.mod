module github.com/open-telemetry/opentelemetry-collector-contrib/exporter/dorisexporter/loadgenerator

go 1.23.3

require github.com/open-telemetry/opentelemetry-collector-contrib/testbed v0.116.0
