...
* `headers` (default is empty map) The [headers](https://doris.apache.org/docs/data-operate/import/import-way/stream-load-manual#load-configuration-parameters) of doris stream load. Only headers that are in the [whitelist](./headers.txt) can be added.
